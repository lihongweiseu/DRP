...
for i in range(1,21):
    ...
    best_params, loss_all, loss_m, cost_time, im, cost_time_str = AUNN_training(1, Nt, u[:1,:], AUNN_model, x_s, in_s, N, y_ref[:1,:], device)
...
R2_train= r2_score(y_ref[0, 0:Nt], y_pre[0, 0:Nt])
R2_test= r2_score(y_ref[1, 0:Nt], y_pre[1, 0:Nt])
# R2_train, R2_test, trainning time, inference_time, parameter number
# 0.9849769838073483, 0.8533131815585303, 33m38s, 0.062258005142211914s, 1295
