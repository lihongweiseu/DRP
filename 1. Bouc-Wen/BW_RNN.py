...
for i in range(2,41,2):
    ...
    best_params, loss_all, loss_m, cost_time, im, cost_time_str = RNN_training(1, Nt1, u[:Nt1,:], RNN_model, in_s, N, y_ref[:Nt1,:], device)
...
# 0.998909181669269, 0.9730423019696385, 45m24s, 0.0656278133392334s, 1680
